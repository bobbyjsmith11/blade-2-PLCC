...
inputBoard = './led_strip.kicad_pcb'
#Output file, original file remains unmodified
outputBoardFile = './led_strip_scriptout.kicad_pcb'

templateRefModulo = 100;	#Difference in the reference numbers between hierarchical sheet
templateRefStart = 1000;		#Starting point of numbering in the first hierarchical sheet
move_dx = FromMM(-120)		#Spacing between clones in x direction
move_dy = FromMM(120)		#Spacing between clones in y direction
